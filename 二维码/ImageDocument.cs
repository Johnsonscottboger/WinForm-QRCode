...
namespace 二维码
{
    class ImageDocument:DocumentBase
    {
        ...
        protected override void OnPrintPage(PrintPageEventArgs e)
        {
            ...
            Rectangle baseFit = GetBaseFitRectangle(e.MarginBounds, Image.Size);

            e.Graphics.DrawImage(Image, baseFit);
            e.Graphics.DrawRectangle(Pens.Black, baseFit);
            e.Graphics.DrawRectangle(Pens.Black, e.MarginBounds);
        }
        protected Rectangle GetBaseFitRectangle(Rectangle toContain,Size objectSize)
        {
            //检查页面是水平还是竖直的。
